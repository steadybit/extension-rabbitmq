...
- feat: fail the prepare step of the queue publish attacks when the exchange parameter is set and the execution targets more than 10 queues, preventing accidental load amplification
