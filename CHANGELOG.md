...
- fix: the publish attacks treated the "Duration (seconds)" parameter as milliseconds, publishing the whole message budget in a burst instead of spreading it across the configured duration
